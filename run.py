...
#from auto_gptq.utils.datautils import *
from auto_gptq import AutoGPTQForCausalLM, BaseQuantizeConfig


pretrained_model_dir = "/home/liukunlong/lkl_model/llama/Llama-2-7b-hf"
quantized_model_dir = "/home/liukunlong/lkl_model/llama/Llama-2-7b-hf-2bit"
...
@torch.no_grad()
def llama_eval(model, testenc, dev, log_wandb: bool = False):
    print("Evaluating ...")

    model=model.model # fix for auto_gptq
...
def main():
    ...
    model = AutoGPTQForCausalLM.from_pretrained(pretrained_model_dir, quantize_config, torch_dtype=torch.float32)
    traindataset, testenc = get_c4(128, 0, 2048, pretrained_model_dir, tokenizer = get_tokenizer(pretrained_model_dir))
    print(model.dtype)
    ...
    for dataset in ["wikitext2", "ptb", "c4"]:
        dataloader, testloader = get_loaders(
            dataset, seqlen=model.seqlen, model=pretrained_model_dir
        )
        print(dataset)
        print(model.dtype)
        llama_eval(model, testloader, dev=DEV)
